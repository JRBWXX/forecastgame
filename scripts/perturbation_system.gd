...
const WIND_SCALE_MIN := 0.85
const WIND_SCALE_MAX := 1.15

## Dewpoint anomaly scale range.
## Applied to the anomaly from a base value, not the absolute dewpoint.
const MOISTURE_SCALE_MIN := 0.80
const MOISTURE_SCALE_MAX := 1.20

## Surface pressure offset range (mb).
## Shifts the entire MSLP field up or down.
const PRESSURE_OFFSET_MIN := -4.0
const PRESSURE_OFFSET_MAX := 4.0
