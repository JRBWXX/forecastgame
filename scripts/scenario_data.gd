...
static func get_scenario(name: String) -> Dictionary:
	match name:
		"april_27_2011_18z":  return _april_27_2011_18z()
		"may_03_1999_18z":    return _may_03_1999_18z()
		_:                     return _april_27_2011_18z()

static func get_scenario_list() -> Array[Dictionary]:
	return [
		{ "id": "april_27_2011_18z", "name": "April 27, 2011 — 128",
		  "desc": "Historic Dixie Alley tornado outbreak. Real reanalysis data, 18Z analysis. Deep negatively-tilted closed low over the central US, powerful jet streak, extreme moisture surge into the warm sector." },
...
static func _april_27_2011_18z() -> Dictionary:
	return {
		"name": "April 27, 2011 — 18Z",
		"type": "real",
		"data_path": "res://scenarios/april_27_2011_18z",
	}
